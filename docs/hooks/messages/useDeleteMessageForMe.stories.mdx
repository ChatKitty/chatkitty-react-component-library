...
<Meta title="Hooks/Messages/useDeleteMessageForMe" />

# <u>useDeleteMessageForMe</u>

Note: This hook does not make an initial request on mount.

```typescript
const { resource, isLoading, error, makeRequest } = useDeleteMessageForMe();
```
...
| :------------ | :------------------------------------ | :--------------------------------------------- |
| `resource`    | Message                               | Message that was deleted                       |
