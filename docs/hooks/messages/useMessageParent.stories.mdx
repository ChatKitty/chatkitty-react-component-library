...
<Meta title="Hooks/Messages/useMessageParent" />

# <u>useMessageParent</u>

Note: This hook does not make an initial request on mount.

```typescript
const { resource, isLoading, error, makeRequest } = useMessageParent();
```
...
| :------------ | :------------------------------------ | :----------------------------------------------- |
| `resource`    | Message                               | Message that is a parent of the provided message |
