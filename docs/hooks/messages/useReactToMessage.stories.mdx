...
<Meta title="Hooks/Messages/useReactToMessage" />

# <u>useReactToMessage</u>

Note: This hook does not make an initial request on mount.

```typescript
const { resource, isLoading, error, makeRequest } = useReactToMessage();
```
...
| :------------ | :--------------------------------------------------- | :--------------------------------------------- |
| `resource`    | Reaction                                             | Reaction that was added                        |
