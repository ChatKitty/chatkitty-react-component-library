...
<Meta title="Hooks/Channels/useUnmuteChannel" />

# <u>useUnmuteChannel</u>

Note: This hook does not make an initial request on mount.

```typescript
const { resource, isLoading, error, makeRequest } = useUnmuteChannel();
```
...
| :------------ | :------------------------------------ | :--------------------------------------------- |
| `resource`    | Channel                               | Channel that was unmuted                       |
